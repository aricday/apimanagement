log.info("Begin MongoDBAudit configInfoCode()");
var configInfo = {
	ui_config: [{
		...
		display: "Audit Collection Name",
		type: "string",
		length: 200,
		required: false,
		parameterName: "audit_collection",
		placeholder: "The name of the collection used to store Audit records",
		description: "Enter the name of the collection used for audit records (default: audit)."
	}, {
		display: "Username",
		type: "string",
		length: 200,
...
log.info("End MongoDBAudit configInfoCode()");
