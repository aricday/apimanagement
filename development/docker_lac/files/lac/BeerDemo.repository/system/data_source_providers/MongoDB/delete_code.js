(function () {
	'use strict';
	log.info('DSP:MongoDB - delete begin');
	...
	if (!doc) {
		logMessage = 'MongoDB - Could not find the entity to be deleted using filter: ' + idQuery;
		log.error(logMessage);
	...
	if (log.isDebugEnabled()) {
		logMessage = 'DSP:MongoDB - delete - Returned ' + result;
		log.debug(logMessage);
	}

	log.info('DSP:MongoDB - delete end');
})();
