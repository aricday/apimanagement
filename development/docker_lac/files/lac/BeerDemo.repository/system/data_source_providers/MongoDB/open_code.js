log.info("DSP:MongoDB - open begin");
...
try {
	...
	if (isDebugEnabled) {
		log.debug("DSP:MongoDB - Connecting to the database: " + settings.dbname);
	}
}
catch (e) {
...
if (isDebugEnabled) {
	log.debug("DSP:MongoDB - open completed successfully. Connection " + conn);
}

log.info("DSP:MongoDB - open end");
return conn;
