return {
    examples: [
        {
            name: "Update backend upon RabbitMQ Message reception",
            code: "<div id='ExampleDiv'>" +
            "   <h3>Update backend upon RabbitMQ Message reception</h3>" +
            "   In this example, we use a <strong>RabbitMQ Listener</strong> to log the incoming messages into a table in the database. The database could be your own or managed" +
