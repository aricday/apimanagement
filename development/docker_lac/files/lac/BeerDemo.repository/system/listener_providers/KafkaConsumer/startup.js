log.debug("Kafka Consumer listener provider is now starting");
try {
   env.KafkaConsumer = Java.type("org.apache.kafka.clients.consumer.KafkaConsumer");
