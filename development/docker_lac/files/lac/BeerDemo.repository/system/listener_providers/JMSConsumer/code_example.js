return {
    examples: [
        {
            name: "Update backend upon JMS Message reception",
            code: "<div id='ExampleDiv'>" +
            "   <h3>Update backend upon JMS Message reception</h3>" +
            "   In this example, we use a <strong>JMS Listener</strong> to log the incoming messages into a table in the database. The database could be your own or managed" +
