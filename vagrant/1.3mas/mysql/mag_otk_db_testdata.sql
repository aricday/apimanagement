-- CA Technologies
-- Database test data for MAG 3.3.00
-- 2016/11
--
...
VALUES ('6438edb0-3e74-48b6-8f08-9034140bd797', '6438edb0-3e74-48b6-8f08-9034140bd797', 'ENABLED', 'admin', '6438edb0-3e74-mag-test-msso-clientAppA', 'AppA', 'https://ios.ssosdk.ca.com/ios', 'openid msso phone profile address email msso_register msso_client_register mas_messaging mas_storage mas_identity_retrieve_users', 'iOS', '{}');
...
INSERT INTO oauth_client_key (client_key, secret, status, created_by, client_ident, client_name, callback, scope, environment, custom)
VALUES ('68d155e9-1402-48a2-9750-e5d9f0746e17', '68d155e9-1402-48a2-9750-e5d9f0746e17', 'ENABLED', 'admin', '6438edb0-3e74-mag-test-msso-clientAppB', 'AppB', 'https://ios.ssosdk.ca.com/ios', 'openid msso phone profile address email msso_register msso_client_register mas_messaging mas_storage mas_identity_retrieve_users', 'iOS', '{}');
...
-- Testapp Aric Test Client:
INSERT INTO oauth_client (client_ident, name, description, organization, registered_by, type, custom)
VALUES ('ba67c443-b5e7-46fb-b141-5d9c2b6f73c9', 'Aric Test Client', 'This client is used for testing the MAS installation', 'Aric Org', 'admin', 'confidential', '{}');
-- Credentials for Aric Test Client:
INSERT INTO oauth_client_key (client_key, secret, status, created_by, client_ident, client_name, callback, scope, environment, custom)
VALUES ('ba67c443-b5e7-46fb-b141-5d9c2b6f73c9', '4d3fc833-0977-417c-9985-2086f5cce1f0', 'ENABLED', 'admin', 'ba67c443-b5e7-46fb-b141-5d9c2b6f73c9', 'Aric Test Client', 'oob', 'openid profile email phone address user_role mas_messaging mas_storage mas_identity_retrieve_users', 'ALL', '{}');
...
INSERT INTO oauth_token (otk_token_id, token,scope,status,client_name,expiration,resource_owner,client_key)
VALUES ('access_token01', 'access_token01', 'scope01','ENABLED', 'client_name01',(unix_timestamp()+3600),'testbuddy1','client_key01');
INSERT INTO oauth_token (otk_token_id, token,scope,status,client_name,expiration,resource_owner,client_key)
VALUES ('access_token02', 'access_token02', 'scope02','ENABLED', 'client_name02',(unix_timestamp()+3600),'testbuddy2','client_key01');
INSERT INTO oauth_token (otk_token_id, token,scope,status,client_name,expiration,resource_owner,client_key)
VALUES ('access_token05', 'access_token05', 'scope02','ENABLED', 'client_name02',(unix_timestamp()+3600),'testbuddy5','client_key02');
INSERT INTO oauth_token (otk_token_id, token,scope,status,client_name,expiration,resource_owner,client_key)
VALUES ('access_token06', 'access_token06', 'scope06','ENABLED', 'client_name02',(unix_timestamp()+3600),'testbuddy6','client_key01');
