-- CA Technologies
-- Database data for MAG 3.3.00 for MySQL
-- 2016/11
--
...
VALUES ('18661300-45df-4cdc-826f-23e402275463', '171f6a0b-deee-44a9-89fe-8dda80b67cba', 'ENABLED', 'admin', '18661300-45df-4cdc-826f-23e402275463', 'MAG Manager', 'https://centos.apim.ca:8443/mag/manager', 'openid profile email user_role', 'MAGServer', '{}');
...
INSERT INTO oauth_client_key (client_key, secret, status, created_by, client_ident, client_name, callback, scope, environment, custom)
VALUES ('c716ac35-ae5b-4870-bfa1-5530c65952f9', '269957e2-5bc0-4a59-b0b5-c37e88460159', 'ENABLED', 'admin', 'c716ac35-ae5b-4870-bfa1-5530c65952f9', 'MAG Authorization Server', 'https://centos.apim.ca:8443/auth/oauth/v2/authorize/login?action=login&provider=enterprise', 'openid profile email', 'MAGServer', '{}');
